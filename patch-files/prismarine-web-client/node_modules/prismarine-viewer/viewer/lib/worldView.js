  ...
  listenToBot (bot) {
    ...
    this.listeners[bot.username] = {
      ...
      entitySpawn: function (e) {
        ...
        (e.name === 'player') ? worldView.emitter.emit('entity', { id: e.id, name: e.name, pos: e.position, width: e.width, height: e.height, username: e.username, skin: e.skin }) : worldView.emitter.emit('entity', { id: e.id, name: e.name, pos: e.position, width: e.width, height: e.height, username: e.username }) 
      },
