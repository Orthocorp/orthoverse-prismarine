...
module.exports = (version) => {
  ...
  class Entity extends EventEmitter {
    constructor (id) {
      ...
      this.metadata = []
      this.skin = {
        // initially set skin to a serf ethereum address, which ends in 1-F
        'default': '0x000000000000000000000000000000000000000' + 
                    (Math.floor(Math.random() * 14) + 1).toString(16), 
        'cape': 'cape_invisible'
      }
      this.ethereum = {
        'wallet': '',
