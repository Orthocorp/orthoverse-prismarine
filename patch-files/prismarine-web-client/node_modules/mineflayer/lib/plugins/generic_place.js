...
function inject (bot) {
  ...
  const mcData = require('minecraft-data')('1.15.2')
    const specialPlace = [
      'dirt', 'grass_block', 
      'white_concrete_stairs', 'orange_concrete_stairs', 'magenta_concrete_stairs',
      'light_blue_concrete_stairs', 'yellow_concrete_stairs', 'lime_concrete_stairs',
      'pink_concrete_stairs', 'gray_concrete_stairs', 'light_gray_concrete_stairs',
      'cyan_concrete_stairs', 'purple_concrete_stairs', 'blue_concrete_stairs',
      'brown_concrete_stairs', 'green_concrete_stairs', 'red_concrete_stairs',
  ...
  async function _genericPlace (referenceBlock, faceVector, options) {
    ...
    if (options.ctrlKey && specialPlace.includes(item.name)){
