...
function inject (bot) {
  ...
  function canDigBlock (block) {
    if (block && 
      ...
      if (bot.entity.skin.onOwned &&
          (Math.floor(block.position.x / 96)) === (Math.floor(bot.entity.position.x / 96)) &&
          (Math.floor(block.position.z / 96)) === (Math.floor(bot.entity.position.z / 96))
        ) {
