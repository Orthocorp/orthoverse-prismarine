...
module.exports.player = function (player, serv, { version }) {
  ...
  const specialPlace = {
      ...
      'yellow_concrete_stairs': ['yellow_concrete_powder', 432],
      'yellow_concrete_powder': ['yellow_concrete_stairs', 684],
      'lime_concrete_stairs': ['lime_concrete', 418],
      'lime_concrete': ['lime_concrete_stairs', 685],
      'pink_concrete_stairs': ['pink_concrete_powder', 435],
      'pink_concrete_powder': ['pink_concrete_stairs', 686],
