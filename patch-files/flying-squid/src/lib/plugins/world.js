...
module.exports.server = async function (serv, { version, worldFolder, generation = { name: 'diamond_square', options: { worldHeight: 80 } } } = {}) {
  ...
  if ('pregen' in generation.options) {
   serv.pregenWorld(serv.overworld, generation.options.pregen)
     .then(() => serv.info('Pre-Generated Overworld sized ' + generation.options.pregen * 2 + " chunks"));
  }
