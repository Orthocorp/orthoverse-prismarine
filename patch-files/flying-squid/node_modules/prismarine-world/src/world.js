...
class World extends EventEmitter {
  ...
  async getColumn (chunkX, chunkZ) {
    ...
    if (!this.columns[key]) {
      ...
      if (this.storageProvider != null) {
        ...
        if (data != null) { chunk = data; console.log("Getting chunk from file") }
      }
  ...
  startSaving () {
    this.savingInt = setInterval(async () => {
      this.counter = this.counter + this.savingQueue.size;
      console.log("Current queue: " + this.savingQueue.size.toString() + "(" + this.counter.toString() + ")")
      await this.saveNow()
    }, this.savingInterval)
  }
