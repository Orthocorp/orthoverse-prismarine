...
function inject (bot) {
  ...
  const specialPlace = {
      ...
      'white_concrete_powder': ['wite_concrete_powder_stairs', 884],
      'orange_concrete_powder_stairs': ['orange_concrete_powder', 430],
      'orange_concrete_powder': ['orange_concrete_powder_stairs', 885],
      'magenta_concrete_powder_stairs': ['magenta_concrete_powder', 431],
      'magenta_concrete_powder': ['magenta_concrete_powder_stairs', 886],
      'light_blue_concrete_powder_stairs': ['light_blue_concrete_powder', 432],
      'light_blue_concrete_powder': ['light_blue_concrete_powder_stairs', 887],
      'yellow_concrete_powder_stairs': ['yellow_concrete_powder', 433],
      'yellow_concrete_powder': ['yellow_concrete_powder_stairs', 888],
      'lime_concrete_powder_stairs': ['lime_concrete_powder', 434],
      'lime_concrete_powder': ['lime_concrete_powder_stairs', 889],
      'pink_concrete_powder_stairs': ['pink_concrete_powder', 435],
      'pink_concrete_powder': ['pink_concrete_powder_stairs', 890],
      'gray_concrete_stairs': ['gray_concrete', 420],
      'gray_concrete': ['gray_concrete_stairs', 891],
      'light_gray_concrete_stairs': ['light_gray_concrete', 421],
      'light_gray_concrete': ['light_gray_concrete_stairs', 892],
      'cyan_concrete_stairs': ['cyan_concrete', 422],
      'cyan_concrete': ['cyan_concrete_stairs', 893],
      'purple_concrete_stairs': ['purple_concrete', 423],
      'purple_concrete': ['purple_concrete_stairs', 894],
      'blue_concrete_stairs': ['blue_concrete', 424],
      'blue_concrete': ['blue_concrete_stairs', 895],
      'brown_concrete_stairs': ['brown_concrete', 425],
      'brown_concrete': ['brown_concrete_stairs', 896],
      'green_concrete_stairs': ['green_concrete', 426],
      'green_concrete': ['green_concrete_stairs', 897],
      'red_concrete_stairs': ['red_concrete', 427],
      'red_concrete': ['red_concrete_stairs', 898],
      'black_concrete_stairs': ['black_concrete', 428],
      'black_concrete': ['black_concrete_stairs', 899]
  }
  /**
   *
