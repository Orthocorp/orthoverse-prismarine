  ...
  function generateSimpleChunk (chunkX, chunkY) {
    ...
    */
    ...
    // start with a plain
      ...
      if (feature === "#") {  specialFn['castle_' + castleLvl.toString()](chunk, level, seedRand, posX, posY) } // we have a castle
    } else {
    // start with tarmac
      ...
      if (feature === "g") {  sea(chunk, seedRand) };
      if (feature === "#") {  specialFn['castle_' + (castleLvl + 8).toString()](chunk, level, seedRand, posX, posY) } // we have a castle
    }
    if (fn) { 
