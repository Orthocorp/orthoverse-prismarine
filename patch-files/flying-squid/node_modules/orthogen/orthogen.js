...
function generation ( { version = '1.15.2', seed } = {}) {
  ...
  function generateSimpleChunk (serv, chunkX, chunkY) {
    ...
    */
    ...
    const specialTileKey = tileX.toString() + ":" + tileY.toString();
    ...
    if (specialTileKey in special) {
      // special features need flat land
      feature = special[specialTileKey].feature[((posY * 6) + posX)];
      fn = specialFn[special[specialTileKey].function]
