...
function generation ( { version = '1.15.2', seed } = {}) {
  ...
  function generateSimpleChunk (serv, chunkX, chunkZ) {
    ...
    if !(landKey in serv.voxel.data) {
      ...
      if (serv.voxel.data[landKey].length !== 6) {
        serv.voxel.data[landKey].push(0) // indicates use save slot 0
      ...
      return serv.voxel.loadChunkFromFile(serv.voxel.data[landKey][6],chunkX, chunkZ)
    }
    */
  }
